...
@Lucifer.on(admin_cmd(outgoing=True, pattern="purge"))
@Lucifer.on(sudo_cmd(allow_sudo=True, pattern="purge"))
@errors_handler
...
@Lucifer.on(admin_cmd(outgoing=True, pattern="purgeme"))
@errors_handler
...
@Lucifer.on(admin_cmd(outgoing=True, pattern="del"))
@errors_handler
...
@Lucifer.on(admin_cmd(outgoing=True, pattern="edit"))
@errors_handler
...
@Lucifer.on(admin_cmd(outgoing=True, pattern="sd"))
@errors_handler
