# @Lucifersupport_group Keep Credits If You Are Goanna Kang This Lol
...
@Lucifer.on(admin_cmd(pattern="avengersdp ?(.*)"))
async def main(event):

    await event.edit(
        "**Starting Avengers Profile Pic...\n\nDone !!! Check Your DP in 5 seconds. By [Alok x](https://github.com/Cat-of-tg/Alok-x-userbot)**"
    )
